...
const UserActions = () => {
  ...
  const menuItems: MenuProps["items"] = [
    ...
    {
      key: "edit-profile",
      label: <div className="flex items-center gap-2 py-2"><UserEdit size="18" />{ t("labels.edit_profile")} </div>,
      onClick:()=>router({ to: "/profile" }), 
    },
    {
      key: "logout",
      label: <div className="flex items-center gap-2 py-2"><LogoutCurve size="18" />{ t("buttons.sign_out")} </div>,
